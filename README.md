...
<p align="center">
  Software Engineer &nbsp;·&nbsp; AI & Web Systems Builder &nbsp;·&nbsp; 9× Hackathon Winner &nbsp;·&nbsp; Speaker<br/>
  Mechanical Engineering Undergraduate, University of Lagos
</p>

<p align="center">
  <a href="https://github.com/Sadiq-Teslim"><img src="https://img.shields.io/badge/GitHub-000?logo=github&logoColor=white&style=flat-square" /></a>
...
<p align="center">
  <em>I build fast, think in systems, and ship products that survive real users.</em>
</p>
...
| | |
|---|---|
| **9×** Hackathon wins | **20,000+** Concurrent users served |
...
### [FairPlay Africa](https://github.com/Sadiq-Teslim) — `ACM Hackathon Grand Prize · ₦10M / $6,500`
...
### [Nevo](https://github.com/Sadiq-Teslim) — `3MTT South-West Regional Champion · Funded & In Production`
...
### [ULES Voting Portal](https://github.com/Sadiq-Teslim) — `Live · 20,000+ votes processed`
...
### [Aegis AI](https://github.com/Sadiq-Teslim) — `AfriHackBox 1st Place Cybersecurity · $1,000`
...
### [GPAi](https://github.com/Sadiq-Teslim) — `2,000+ active users`
...
**Frontend**
`React` `Next.js` `Tailwind CSS` `Shadcn/ui` `Redux` `Zustand` `Radix UI`

**Backend**
`Node.js` `Express.js` `FastAPI` `Django` `Spring Boot`

**Databases & Caching**
`MongoDB` `PostgreSQL` `Redis` — query optimization, indexing, transactions

**Infra & DevOps**
`Docker` `GitHub Actions` `AWS (S3, EC2)` `CI/CD` `BullMQ` `Vercel` `Render`

**Payments**
`Paystack` `Stripe` — idempotent transactions, webhook processing

**AI / ML**
`SLM integration & inference` `Gemini API` `LLM integration` `Content personalization pipelines`
...
Follow along: **[@teslimcodes](https://x.com/teslimcodes)** on X

---

<p align="center">
  📍 Lagos, Nigeria &nbsp;·&nbsp;
  📧 <a href="mailto:sadiqadetola08@gmail.com">sadiqadetola08@gmail.com</a> &nbsp;·&nbsp;
  🌐 <a href="https://teslimcodes.tech">teslimcodes.tech</a>
</p>
